...
public class SwaggerConfiguration {
	...
	private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Currency-Conversion-Service Using Spring Cloud", 
				"This is a MS created using Spring Cloud to convert the Currency.",
